...
public class EventDetailsActivity extends AppCompatActivity {
    private static String TAG = "EventDetailsActivity";
    Context context;
    ...
    String getToken, getKey;

    FrameLayout back_con;
    ImageView back, image_view;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                setDarkMode(EventDetailsActivity.this, true);
            }
        }
    ...
    void showing() {
        final String url = ServerUrl.getBaseUrl() + "/setting/eventdetail";
            ...
            public void callback(String url, JSONObject jsonObject, AjaxStatus status) {
                ...
                try {
                    if (jsonObject.getBoolean("return")) {    //return이 true 면?
                        ...
                        putImage(image_view, ServerUrl.getBaseUrl() + "/uploads/images/origin/" + jsonData.getString("content"));

                    } else if (!jsonObject.getBoolean("return")) {
                        oneBtnDialog = new OneBtnDialog(EventDetailsActivity.this, "게시글 불러오기 실패", "확인");
