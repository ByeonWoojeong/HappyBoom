package app.woojeong.happyboom.CustomTabLayout;
...
public class TabLayoutWithArrow extends HorizontalScrollView {
    ...
    private static final int FIXED_WRAP_GUTTER_MIN = 18; //dps
...
//            //그라데이션1(오른쪽)
//            ((MainActivity)MainActivity.context).findViewById(R.id.tab_gradation_1).setVisibility(VISIBLE);
//            ((MainActivity)MainActivity.context).findViewById(R.id.tab_gradation_2).setVisibility(GONE);

        }
        else if(!this.canScrollHorizontally(1)){
//            //그라데이션2(왼쪽)
//            ((MainActivity)MainActivity.context).findViewById(R.id.tab_gradation_1).setVisibility(GONE);
//            ((MainActivity)MainActivity.context).findViewById(R.id.tab_gradation_2).setVisibility(VISIBLE);
        }
    }
     ...
     *     this TabLayout.</li>
     *     <li>Populate the TabLayout's tabs from the ViewPager's {@link androidx.viewpager.widget.PagerAdapter}.</li>
     *     <li>Set our {@link OnTabSelectedListener} which will forward
     *     selected events to the ViewPager</li>
     * </ul>
     * </p>
     *
     * @see #setTabsFromPagerAdapter(androidx.viewpager.widget.PagerAdapter)
     * @see TabLayoutOnPageChangeListener
     * @see ViewPagerOnTabSelectedListener
     */
    public void setupWithViewPager(@NonNull ViewPager viewPager) {
        final androidx.viewpager.widget.PagerAdapter adapter = viewPager.getAdapter();
        if (adapter == null) {
    ...
    /**
     * Populate our tab content from the given {@link androidx.viewpager.widget.PagerAdapter}.
     * <p>
     * Any existing tabs will be removed first. Each tab will have it's text set to the value
     * returned from {@link androidx.viewpager.widget.PagerAdapter#getPageTitle(int)}
     * </p>
     *
     * @param adapter the adapter to populate from
     */
    public void setTabsFromPagerAdapter(@NonNull androidx.viewpager.widget.PagerAdapter adapter) {
        removeAllTabs();
    ...
    class TabView extends LinearLayout implements OnLongClickListener {
        ...
        public TabView(Context context, Tab tab) {
            ...
            if (mTabBackgroundResId != 0) {
                setBackgroundDrawable(getDrawable(context, mTabBackgroundResId));
            }
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        private Path getTrianglePath(int arrowSize) {
            ...
            Point top = new Point(bottomPointX + arrowSize, leftPointY);
            Point right = new Point(rightPointX + arrowSize, bottomPointY);
            Point left = new Point(leftPointX + arrowSize, bottomPointY);
