...
public class FindPassword1Activity extends AppCompatActivity {
    private static String TAG = "FindPassword1Activity";
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                setDarkMode(FindPassword1Activity.this, true);
            }
        }
        ...
        verify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ("".equals(my_number.getText().toString())) {
                    ...
                    oneBtnDialog.show();
                    return;
                } else if (my_number.length() < 4 && 4 < my_number.length()) {
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!isPhone){
                    ...
                    oneBtnDialog = new OneBtnDialog(context, "인증 번호를 확인해주세요 !", "확인");
                    oneBtnDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                    oneBtnDialog.setCancelable(false);
                    oneBtnDialog.show();
                    return;
            ...
            public void callback(String url, JSONObject jsonObject, AjaxStatus status) {
                ...
                try {
                    if (jsonObject.getBoolean("return")) {    //return이 true 면?
                        Toast.makeText(FindPassword1Activity.this, "인증 번호를 보냈습니다.", Toast.LENGTH_SHORT).show();
                        if(null != jsonObject.getString("cert") && !"".equals(jsonObject.getString("cert"))){
                            oneBtnDialog = new OneBtnDialog(FindPassword1Activity.this, "인증 번호 : " + jsonObject.getString("cert"), "확인");
                            oneBtnDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                            oneBtnDialog.setCancelable(false);
                            oneBtnDialog.show();
                        }
                    } else if (!jsonObject.getBoolean("return")) {
                        oneBtnDialog = new OneBtnDialog(FindPassword1Activity.this, "다시 시도해주세요 !", "확인");
                        oneBtnDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                        oneBtnDialog.setCancelable(false);
                        oneBtnDialog.show();
                    }
    ...
    void verifySMS() {
        ...
        aQuery.ajax(url, params, JSONObject.class, new AjaxCallback<JSONObject>() {
            ...
            public void callback(String url, JSONObject jsonObject, AjaxStatus status) {
                ...
                try {
                    if (jsonObject.getBoolean("return")) {    //return이 true 면?
                        Toast.makeText(FindPassword1Activity.this, "인증 번호가 확인되었습니다.", Toast.LENGTH_SHORT).show();
                        if(null != jsonObject.getString("cert") && !"".equals(jsonObject.getString("cert"))){
                            oneBtnDialog = new OneBtnDialog(FindPassword1Activity.this, "인증 번호 : " + jsonObject.getString("cert"), "확인");
                            oneBtnDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                            oneBtnDialog.setCancelable(false);
                        ...
                        oneBtnDialog = new OneBtnDialog(FindPassword1Activity.this, "인증 번호 확인을\n다시 시도해주세요 !", "확인");
                        oneBtnDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                        oneBtnDialog.setCancelable(false);
                        oneBtnDialog.show();
                    }
